...
import { VanderMariaViewport } from './components/VanderMariaViewport';
...
export default function Home() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // 🔴 BRANCH 1: VANDER MARIA (Isolado completamente)
      if (carouselTemplate === 'vanderMaria') {
        ...
        // Transformar para CarouselCard format
      ...
      // 🔴 BRANCH 2: TWEET/STANDARD (Fluxo existente - intocado)
      ...
      if (data.cards) {
        ...
        setCards(cards);
        console.log('✅ Cards Tweet salvos! Pronto para adicionar imagens e publicar.');
      }
    } catch (error) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="flex gap-8 px-6 py-8 min-h-[calc(100vh-280px)]">
        ...
        {/* RIGHT: Cards Viewport (Maximized) */}
